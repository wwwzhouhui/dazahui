...
class XunFeiBot(Bot):
    def __init__(self):
        ...
        self.app_id = "55f54687"
        self.api_key = "0dca3d2c79c0c243af6b96bb4f295dc3"
        self.api_secret = "ddadbae228ea2e914c5aab4c2c194082"
        ...
        self.sessions = SessionManager(WenxinSession, model="xunfei")
    ...
    def create_url(self):
        ...
        logger.info(f"[XunFei] start create_url, url={url}")
        return url
